 ...
 * 读书直播分享会活动资讯
 * 复用作家专区的布局文件及内容，更改查询的数据库表格
 */
public class BroadCastFragment extends Fragment {
    private ListView lv_broadcast;
    private List<Map<String, Object>> broadCastList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        lv_broadcast = view.findViewById(R.id.lv_broadcast);
        return view;
    }
    ...
    private void initData() {
        List<Communication> communications = mHelper.queryAllBroadcast();
    ...
    private void updateUI(List<Communication> communications) {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(getContext(), broadCastList, R.layout.item_writer, from, to) {
            @Override
            public View getView(int position, View convertView, ViewGroup parent) {
                View view = super.getView(position, convertView, parent);
                ImageView iv_writerBackground = view.findViewById(R.id.iv_writerBackground);
                String avatarUrl = (String) broadCastList.get(position).get("background");
        ...
        lv_broadcast.setAdapter(simpleAdapter);
    }
